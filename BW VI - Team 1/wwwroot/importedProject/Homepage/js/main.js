document.addEventListener("DOMContentLoaded", () => {
    ...
    var myAnimation = new hoverEffect({
        ...
        image1: `/importedProject/Homepage/img/${bgImgs[0]}`,
        image2: `/importedProject/Homepage/img/${bgImgs[1]}`,
        displacementImage: "/importedProject/Homepage/img/index_base.jpg",
        hover: false,
    });
    ...
    var myAnimation2 = new hoverEffect({
        ...
        intensity: 0.3,
        imagesRatio: 1080 / 1920,
        image1: `/importedProject/Homepage/img/${bgImgs[1]}`,
        image2: `/importedProject/Homepage/img/${bgImgs[2]}`,
        displacementImage: "/importedProject/Homepage/img/index_base.jpg",
        hover: false,
    });
    ...
    var myAnimation3 = new hoverEffect({
        ...
        intensity: 0.3,
        imagesRatio: 1080 / 1920,
        image1: `/importedProject/Homepage/img/${bgImgs[2]}`,
        image2: `/importedProject/Homepage/img/${bgImgs[3]}`,
        displacementImage: "/importedProject/Homepage/img/index_base.jpg",
        hover: false,
    });
    ...
    var myAnimation4 = new hoverEffect({
        ...
        intensity: 0.3,
        imagesRatio: 1080 / 1920,
        image1: `/importedProject/Homepage/img/${bgImgs[3]}`,
        image2: `/importedProject/Homepage/img/${bgImgs[0]}`,
        displacementImage: "/importedProject/Homepage/img/index_base.jpg",
        hover: false,
    });
