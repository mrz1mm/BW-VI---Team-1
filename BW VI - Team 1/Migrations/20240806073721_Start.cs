        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MicrochipNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRefound = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recoverys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Recoverys_Animals_AnimalId",
                        column: x => x.AnimalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUsage", x => new { x.ProductsId, x.UsagesId });
                    table.ForeignKey(
                        name: "FK_ProductUsage_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductUsage_Usages_UsagesId",
                        column: x => x.UsagesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUsage_UsagesId",
                table: "ProductUsage",
                column: "UsagesId");

            migrationBuilder.CreateIndex(
                name: "IX_Recoverys_AnimalId",
                table: "Recoverys",
                column: "AnimalId");
